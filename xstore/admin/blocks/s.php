    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation" >
                <div class="logo" style="background-color: #F6F7FA">
                    <a href="index.php"><img src="img/logo1.png"></a>
                </div>
                <div class="navi">
                    <ul>
                        <li class="active" style="color: black"><a href="user-indexs.php"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Quản lý người dùng</span></a></li>
                        <li><a href="category-index.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Quản lý danh mục</span></a></li>
                        <li><a href="product-index.php"><i class="fas fa-mobile"></i></i><span class="hidden-xs hidden-sm">Quản lý sản phẩm</span></a></li>
                        <li><a href="order.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Quản lý đơn hàng</span></a></li>
